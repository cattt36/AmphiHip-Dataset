...
________________________________________________________________________________________________________________________________________________________
|        1        |     M     |   28    |   1.78   |    79     |  FW, IW, Run, SW, SQ     |    FW: speed = 4.5 km/h, IW: speed = 3 km/h, incline = 7           |
|                  |             |           |            |            |                                       |    Run: speed = 9 km/h,      SQ: 5 kg load                                   |
|        2        |     M     |   26    |   1.76   |    88     |  FW, IW, Run, SW           |    FW: speed = 4.2 km/h, IW: speed = 3 km/h, incline = 5           |
|                  |             |           |            |            |                                       |    Run: speed = 8.5 km/h                                                            |
|        3        |      F     |   24    |   1.61   |    50     |  FW, IW, Run, SW, SQ     |    FW: speed = 3.5 km/h, IW: speed = 2.7 km/h, incline = 4         |
|                  |             |           |            |            |                                       |    Run: speed = 7 km/h, SQ: no load                                           |
|        4        |     M     |   29    |   1.82   |    89     |  FW, IW, Run, SW, SQ     |    FW: speed = 5 km/h, IW: speed = 3.5 km/h, incline = 8           |
|                  |             |           |            |            |                                       |    Run: speed = 10 km/h, SQ: 10 kg load                                     |
|        5        |     M     |   30    |   1.71   |    77    |  FW, IW, Run, SW, SQ      |    FW: speed = 5 km/h, IW: speed = 3 km/h, incline = 6              |
|                  |             |           |            |            |                                        |    Run: speed = 10 km/h, SQ: 5 kg load                                      |
|        6        |     M     |   25    |   1.83   |    93    |  FW, IW, Run, SW             |    FW: speed = 5.2 km/h, IW: speed = 4 km/h, incline = 10         |
|                  |             |           |            |           |                                         |    Run: speed = 11 km/h                                                            |
|        7        |      F     |   25    |   1.66   |    47    |  FW, IW, Run, SW             |    FW: speed = 3.8 km/h, IW: speed = 2.5 km/h, incline = 5        |
|                  |             |           |            |                                                     |    Run: speed = 8.5 km/h                                                           |
|        8        |     M     |   26    |   1.73   |    61    |  FW, IW, Run, SW             |    FW: speed = 4.5 km/h, IW: speed = 3.4 km/h, incline = 6       |
|                  |             |           |            |           |                                         |    Run: speed = 9.5 km/h                                                          |
|        9        |      F     |   24    |   1.60   |    53    |  FW, IW, Run, SW              |    FW: speed = 3 km/h, IW: speed = 2.5 km/h, incline = 6         |
|                  |             |           |            |           |                                          |    Run: speed = 8.5 km/h                                                          |
